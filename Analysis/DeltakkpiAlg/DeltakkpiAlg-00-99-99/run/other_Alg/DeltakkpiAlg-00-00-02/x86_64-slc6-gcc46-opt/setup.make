...
use DecayChain DecayChain-00-00-03-slc6tag Event (/afs/ihep.ac.cn/bes3/offline/Boss/7.0.3)
...
use McDecayModeSvc McDecayModeSvc-00-00-01 Analysis (/workfs/bes/wangziyi/7.0.3)
...
use Pi0EtaToGGRecAlg Pi0EtaToGGRecAlg-00-00-11 Reconstruction (/afs/ihep.ac.cn/bes3/offline/Boss/7.0.3)
use BesDChain BesDChain-00-00-14 Event (/afs/ihep.ac.cn/bes3/offline/Boss/7.0.3)
...
wangziyi_no_config (from PROJECT) excludes [wangziyi_config]
wangziyi_root (from PROJECT) excludes [wangziyi_no_root]
wangziyi_cleanup (from PROJECT) excludes [wangziyi_no_cleanup]
wangziyi_scripts (from PROJECT) excludes [wangziyi_no_scripts]
wangziyi_prototypes (from PROJECT) excludes [wangziyi_no_prototypes]
wangziyi_with_installarea (from PROJECT) excludes [wangziyi_without_installarea]
wangziyi_with_version_directory (from PROJECT) excludes [wangziyi_without_version_directory]
wangziyi (from PROJECT)
...
----------> CMTPATH
# Add path /workfs/bes/wangziyi/7.0.3 from initialization
