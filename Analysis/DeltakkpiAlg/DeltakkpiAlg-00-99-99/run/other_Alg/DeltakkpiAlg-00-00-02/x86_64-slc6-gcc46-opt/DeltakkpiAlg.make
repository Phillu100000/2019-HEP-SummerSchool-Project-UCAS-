...
$(DeltakkpiAlglib) :: $(bin)Deltakkpi.o $(bin)ReadBeamInfFromDb.o $(bin)Ds_load.o $(bin)Ds_entries.o
	$(lib_echo) library
	$(lib_silent) cd $(bin); \
	  $(ar) $(DeltakkpiAlglib) $?
...
DeltakkpiAlgclean ::
	...
	$(cleanup_silent) cd $(bin); /bin/rm -f $(bin)Deltakkpi.o $(bin)ReadBeamInfFromDb.o $(bin)Ds_load.o $(bin)Ds_entries.o
...
$(bin)$(binobj)ReadBeamInfFromDb.o : $(cmt_final_setup_DeltakkpiAlg)

$(bin)$(binobj)ReadBeamInfFromDb.o : $(src)ReadBeamInfFromDb.cxx
	$(cpp_echo) $(src)ReadBeamInfFromDb.cxx
	$(cpp_silent) $(cppcomp) -MMD -MP -MF $*.d -MQ $@ -o $@ $(use_pp_cppflags) $(DeltakkpiAlg_pp_cppflags) $(lib_DeltakkpiAlg_pp_cppflags) $(ReadBeamInfFromDb_pp_cppflags) $(use_cppflags) $(DeltakkpiAlg_cppflags) $(lib_DeltakkpiAlg_cppflags) $(ReadBeamInfFromDb_cppflags) $(ReadBeamInfFromDb_cxx_cppflags)  $(src)ReadBeamInfFromDb.cxx
endif
endif

else
$(bin)DeltakkpiAlg_dependencies.make : $(ReadBeamInfFromDb_cxx_dependencies)

$(bin)DeltakkpiAlg_dependencies.make : $(src)ReadBeamInfFromDb.cxx

$(bin)$(binobj)ReadBeamInfFromDb.o : $(ReadBeamInfFromDb_cxx_dependencies)
	$(cpp_echo) $(src)ReadBeamInfFromDb.cxx
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(DeltakkpiAlg_pp_cppflags) $(lib_DeltakkpiAlg_pp_cppflags) $(ReadBeamInfFromDb_pp_cppflags) $(use_cppflags) $(DeltakkpiAlg_cppflags) $(lib_DeltakkpiAlg_cppflags) $(ReadBeamInfFromDb_cppflags) $(ReadBeamInfFromDb_cxx_cppflags)  $(src)ReadBeamInfFromDb.cxx
